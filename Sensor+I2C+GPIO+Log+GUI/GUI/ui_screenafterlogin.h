...
public:
    ...
    void retranslateUi(QDialog *ScreenAfterLogin)
    {
        ...
        setTemp->setText(QApplication::translate("ScreenAfterLogin", "Temperature", 0, QApplication::UnicodeUTF8));
        pushButton->setText(QApplication::translate("ScreenAfterLogin", "Open Deur", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
