...
struct qt_meta_stringdata_ScreenAfterLogin_t {
    QByteArrayData data[7];
    char stringdata[95];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ScreenAfterLogin_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ScreenAfterLogin_t qt_meta_stringdata_ScreenAfterLogin = {
    {
...
const QMetaObject ScreenAfterLogin::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ScreenAfterLogin.data,
      qt_meta_data_ScreenAfterLogin,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ScreenAfterLogin.stringdata))
