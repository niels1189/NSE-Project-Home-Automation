...
struct qt_meta_stringdata_temperaturescreen_t {
    QByteArrayData data[8];
    char stringdata[92];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_temperaturescreen_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_temperaturescreen_t qt_meta_stringdata_temperaturescreen = {
    {
...
QT_MOC_LITERAL(7, 85, 6)
    ...
    "temperaturescreen\0resettimer\0\0tempSensor\0"
    "LcdNumber_2_Display\0i\0on_pushButton_clicked\0"
    "LogOut"
};
...
const QMetaObject temperaturescreen::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_temperaturescreen.data,
      qt_meta_data_temperaturescreen,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_temperaturescreen.stringdata))
